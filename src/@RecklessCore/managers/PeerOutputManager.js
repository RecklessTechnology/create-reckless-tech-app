...
export const PeerOutputContext = React.createContext(null);
...
const PeerOutputManager = ({
    ...
    return (
        <PeerOutputContext.Provider value={{}}>
          {children}
        </PeerOutputContext.Provider>
    );
}

PeerOutputManager.whyDidYouRender = false;

export default PeerOutputManager;